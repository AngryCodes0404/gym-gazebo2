...
def getArgsParserMARA():
    ...
    parser.add_argument(
        "-g", "--gzclient", action="store_true", help="Run user interface."
    )
    parser.add_argument(
        "-r",
        "--realSpeed",
        action="store_true",
        help="Execute the simulation in \
    ...
    group.add_argument(
        ...
        type=int,
        default=11345,
        help="Provide exact port to the \
